...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:- https://t.me/ULTRA_BHAI,https://t.me/ULTRA_BHAI."
...
✅ Usage: /remove <userid>'''
        ...
        response = "You have not purchased yet purchase now from:- https://t.me/ULTRA_BHAI
🙇."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- https://t.me/ULTRA_BHAI🙇."
    bot.reply_to(message, response)
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, ULTRA 𝐏𝐎𝐖𝐄𝐑 𝐒𝐓𝐀𝐑𝐓.\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐇𝐄𝐓𝐀𝐑 𝐊𝐈 𝐌𝐀𝐀 𝐊𝐈 𝐂𝐇𝐔𝐓 - https://t.me/ULTRA_BHAI"
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            response = "🔮Usage :- /bgmi <target> <port> <time> IP PORT DAL BHAI"  # Updated command syntax
    else:
        response = ("BHAI BOT KO UES KARNE KE LIYE BUY PREMIUM ACCESS /bgmi command. DM TO BUY ACCESS:- https://t.me/ULTRA_BHAI")
...
Buy From :- https://t.me/ULTRA_BHAI,
Official Channel :- http://t.me/+PBF_2-hfyI9kNWQ1
'''
...
💌DM TO BUY :- https://t.me/ULTRA_BHAI'''
    bot.reply_to(message, response)
